//TRABALHO Pizzaria.c // KAIKY TREVISAN FERNANDES, MATEUS SILVA MACIEL
#include <stdio.h>
#include <string.h>
#include <conio2.h>
#include <ctype.h>
...
typedef struct tpcliente TpCliente;
...
typedef struct tpmotoqueiro TpMotoqueiro;
...
typedef struct tppizza TpPizza;
